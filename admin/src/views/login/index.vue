            ...
            <n-gi span="24 600:18 1200:8">
                <div class="login-card">
                    ...
                    <n-form ref="formRef" :model="model" :rules="rules" :show-require-mark="false">
                        ...
                        <n-form-item size="small" inline :show-label="false" :feedback="showAgreementFeedback"
                            :show-feedback="showFeedback" :validation-status="checkAgreementStatus">
                            <div style="display: flex; justify-content: space-between; align-items: center;width: 100%;">
                                <n-checkbox v-model:checked="model.check" size="large" style="margin: 10px 0;"
                                    path="check"><n-button text @click="showAgreement">请阅读并勾选用户协议
                                    </n-button></n-checkbox>
                                <router-link to="/register" style="font-size:medium; margin-right: 2rem;">前往注册</router-link>
                            </div>
                        </n-form-item>
                        <!-- 添加窗口 -->
                        <div style="display: flex; justify-content: flex-end">
                            <n-button class="login-button" createLocalStorage type="primary" @click="loginHandle"
                                :loading="isLoading">
                                登录
                            </n-button>
                        </div>
